  ...
  let lib t =
    ...
    | Solo5 ->
        ...
        [
          ...
          (* needed for mirage-crypto *)
          file "crt/x86intrin.h";
          file "crt/clzerointrin.h";
          file "crt/cpuid.h";
          (* needed by x86intrin.h *)
          file "crt/adxintrin.h";
          file "crt/ammintrin.h";
          file "crt/avx2intrin.h";
          file "crt/avx5124fmapsintrin.h";
          file "crt/avx5124vnniwintrin.h";
          file "crt/avx512bitalgintrin.h";
          file "crt/avx512bwintrin.h";
          file "crt/avx512cdintrin.h";
          file "crt/avx512dqintrin.h";
          file "crt/avx512erintrin.h";
          file "crt/avx512fintrin.h";
          file "crt/avx512ifmaintrin.h";
          file "crt/avx512ifmavlintrin.h";
          file "crt/avx512pfintrin.h";
          file "crt/avx512vbmi2intrin.h";
          file "crt/avx512vbmi2vlintrin.h";
          file "crt/avx512vbmiintrin.h";
          file "crt/avx512vbmivlintrin.h";
          file "crt/avx512vlbwintrin.h";
          file "crt/avx512vldqintrin.h";
          file "crt/avx512vlintrin.h";
          file "crt/avx512vnniintrin.h";
          file "crt/avx512vnnivlintrin.h";
          file "crt/avx512vpopcntdqintrin.h";
          file "crt/avx512vpopcntdqvlintrin.h";
          file "crt/avxintrin.h";
          file "crt/bmi2intrin.h";
          file "crt/bmiintrin.h";
          file "crt/cetintrin.h";
          file "crt/cldemoteintrin.h";
          file "crt/clflushoptintrin.h";
          file "crt/clwbintrin.h";
          file "crt/emmintrin.h";
          file "crt/f16cintrin.h";
          file "crt/fma4intrin.h";
          file "crt/fmaintrin.h";
          file "crt/fxsrintrin.h";
          file "crt/gfniintrin.h";
          file "crt/ia32intrin.h";
          file "crt/immintrin.h";
          file "crt/lwpintrin.h";
          file "crt/lzcntintrin.h";
          file "crt/mm3dnow.h";
          file "crt/mm_malloc.h";
          file "crt/mmintrin.h";
          file "crt/movdirintrin.h";
          file "crt/mwaitxintrin.h";
          file "crt/pconfigintrin.h";
          file "crt/pkuintrin.h";
          file "crt/pmmintrin.h";
          file "crt/popcntintrin.h";
          file "crt/prfchwintrin.h";
          file "crt/rdseedintrin.h";
          file "crt/rtmintrin.h";
          file "crt/sgxintrin.h";
          file "crt/shaintrin.h";
          file "crt/smmintrin.h";
          file "crt/tbmintrin.h";
          file "crt/tmmintrin.h";
          file "crt/vaesintrin.h";
          file "crt/vpclmulqdqintrin.h";
          file "crt/waitpkgintrin.h";
          file "crt/wbnoinvdintrin.h";
          file "crt/wmmintrin.h";
          file "crt/xmmintrin.h";
          file "crt/xopintrin.h";
          file "crt/xsavecintrin.h";
          file "crt/xsaveintrin.h";
          file "crt/xsaveoptintrin.h";
          file "crt/xsavesintrin.h";
          file "crt/xtestintrin.h";
        ]
...
let gen_flags t install_dir =
  ...
  | t ->
      ...
      let cflags =
        (* FIXME: that won't work if solo5 is not installed in the workspace. *)
        let solo5_dir = Filename.dirname install_dir / "solo5" in
